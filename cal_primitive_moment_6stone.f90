...
module cube_ana
    ...
    contains
        ...
        subroutine match(ndx_cube,got_issue)
            ...
            cube_tensor(:,1) = (/rxrx, rxry, rxrz/)
            cube_tensor(:,2) = (/rxry, ryry, ryrz/)
            cube_tensor(:,3) = (/rxrz, ryrz, rzrz/)
        ...
        subroutine molecule_comp()
            ...
            do ndx_mole = 1, num_mole
                ...
                do ndx_nuke = 1, num_nuke
                    ...
                    nuke_tensor(:,1) = (/rx_n*rx_n, rx_n*ry_n, rx_n*rz_n/)
                    nuke_tensor(:,2) = (/ry_n*rx_n, ry_n*ry_n, ry_n*rz_n/)
                    nuke_tensor(:,3) = (/rz_n*rx_n, rz_n*ry_n, rz_n*rz_n/)
